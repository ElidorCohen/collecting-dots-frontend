...
import { Music, Upload, Mail, Instagram, FileAudio, X, Play, Users, Headphones, Star } from 'lucide-react'
...
import HorizontalVideosCarousel from "@/components/horizontal-videos-carousel"
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              >
                ...
                <g>
                  <path className="cls-1" d="M193.08,18.94c8.27,0,15.15,6.36,16.8,13.75h18.28c-1.56-16.84-16.44-29.84-35.08-29.84-20.57,0-36.09,14.5-36.09,34.23s15.15,34.33,35.72,34.33c17.91,0,32.14-11.97,35.26-28.25h-18.73c-2.29,7.29-8.72,11.97-16.53,11.97-10.1,0-17.54-7.67-17.54-18.05s7.8-18.15,17.91-18.15"/>
                  <path className="cls-1" d="M267.93,55.04c-10.1,0-17.72-7.58-17.72-17.96s7.62-17.87,17.72-17.87,17.63,7.58,17.63,17.87-7.62,17.96-17.63,17.96M267.93,2.85c-20.57,0-35.91,14.59-35.91,34.24s15.43,34.33,35.91,34.33,35.82-14.69,35.82-34.33-15.24-34.24-35.82-34.24"/>
                  <polygon className="cls-1" points="347.22 54.76 327.39 54.76 327.39 4.35 309.76 4.35 309.76 69.82 347.22 69.82 347.22 54.76"/>
                  <polygon className="cls-1" points="391.07 54.76 371.23 54.76 371.23 4.35 353.6 4.35 353.6 69.82 391.07 69.82 391.07 54.76"/>
                  <polygon className="cls-1" points="397.44 69.82 435.27 69.82 435.27 55.23 415.07 55.23 415.07 44.66 433.71 44.66 433.71 30.07 415.07 30.07 415.07 19.4 435.27 19.4 435.27 4.34 397.44 4.34 397.44 69.82"/>
                  <path className="cls-1" d="M475.64,18.94c8.27,0,15.15,6.36,16.81,13.75h18.27c-1.56-16.84-16.44-29.84-35.08-29.84-20.57,0-36.09,14.5-36.09,34.23s15.15,34.33,35.72,34.33c17.91,0,32.14-11.97,35.26-28.25h-18.73c-2.3,7.29-8.72,11.97-16.53,11.97-10.1,0-17.54-7.67-17.54-18.05s7.81-18.15,17.91-18.15"/>
                  <polygon className="cls-1" points="512.68 18.94 525.72 18.94 525.72 69.82 543.35 69.82 543.35 18.94 556.39 18.94 556.39 4.35 512.68 4.35 512.68 18.94"/>
                  <rect className="cls-1" x="565.18" y="4.35" width="17.63" height="65.48"/>
                  <polygon className="cls-1" points="640.88 41.37 638.91 41.47 610.19 4.37 592.3 4.37 592.3 69.85 609.84 69.85 609.84 33.78 611.99 33.78 639.61 69.85 658.42 69.85 658.42 4.37 640.88 4.37 640.88 41.37"/>
                  <path className="cls-1" d="M697.66,33.49v14.22h13.04c-1.01,6.45-6.52,9.17-12.4,9.17-10.1,0-15.06-9.17-15.06-19.55s4.68-19.08,15.06-19.08c6.7,0,11.3,4.77,13.78,9.82l16.07-7.48c-5.33-10.29-14.6-17.49-29.66-17.49-20.3,0-33.43,14.96-33.43,34.23,0,19.74,12.58,34.33,33.34,34.33,19.1,0,31.96-13.56,32.14-30.68v-7.48h-32.88Z"/>
                  <path className="cls-1" d="M267.93,133.3c-10.1,0-17.72-7.58-17.72-17.96s7.62-17.87,17.72-17.87,17.63,7.58,17.63,17.87-7.62,17.96-17.63,17.96M267.93,81.11c-20.57,0-35.91,14.59-35.91,34.24s15.43,34.33,35.91,34.33,35.82-14.69,35.82-34.33-15.24-34.24-35.82-34.24"/>
                  <polygon className="cls-1" points="305.44 97.19 318.48 97.19 318.48 148.08 336.11 148.08 336.11 97.19 349.15 97.19 349.15 82.6 305.44 82.6 305.44 97.19"/>
                  <path className="cls-1" d="M373.32,100.09c0-3.09,2.66-4.86,5.97-4.86,4.13,0,8.45,2.71,12.3,5.8l7.44-13.19c-4.59-3.27-11.85-6.55-21.21-6.55-13.04,0-23.33,6.73-23.42,21.42-.09,21.51,26.08,14.12,26.08,25.26,0,4.02-3.31,6.08-7.07,6.08-5.33,0-11.2-3.55-15.79-8.61l-7.99,14.22c4.32,4.4,14.6,9.82,25.16,9.82,11.66,0,24.15-7.58,24.34-22.64.28-22.54-25.8-16.74-25.8-26.75"/>
                  <path className="cls-1" d="M115.76,97.48c10.01,0,17.63,7.58,17.63,17.87s-7.62,17.96-17.63,17.96-17.72-7.58-17.72-17.96,7.62-17.87,17.72-17.87M0,150.04h150.04V0H0v150.04Z"/>
                  <path className="cls-1" d="M192.66,133.39h-14.7v-36.39h14.7c10.01,0,18.11,7.55,18.11,17.83s-7.74,18.55-18.11,18.55M192.57,82.6h-31.29v65.48h32.11c20.66,0,34.48-13.1,34.48-33.21s-14.83-32.27-35.3-32.27"/>
                </g>
              </svg>
            </div>
            <div className="hidden md:flex items-center space-x-8">
              <a href="#releases" className="text-gray-300 hover:text-white transition-colors font-medium">Releases</a>
              <a href="#sounds" className="text-gray-300 hover:text-white transition-colors font-medium">Sounds</a>
              <a href="#sets" className="text-gray-300 hover:text-white transition-colors font-medium">Sets</a>
              <a href="#merchandise" className="text-gray-300 hover:text-white transition-colors font-medium">Merchandise</a>
              <a href="#demo-submission" className="text-gray-300 hover:text-white transition-colors font-medium">Submit Demo</a>
            </div>
          </div>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 font-light leading-relaxed">
                Founded in 2018, Collecting Dots has become a beacon for innovative electronic music. 
                We bridge the gap between underground talent and global audiences, fostering a community 
              ...
              <Card key={index} className="bg-gray-900/80 border-gray-800/50 group hover:border-gray-700/50 transition-all duration-500 backdrop-blur-sm">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex space-x-3">
                    <Button className="flex-1 bg-white text-black hover:bg-gray-200 font-medium">
                      Download
                    </Button>
                    <Button variant="outline" className="border-gray-600 text-gray-300 hover:bg-gray-800/50 font-medium">
                      Preview
                    </Button>
                  </div>
                </CardContent>
                      ...
                      {item.colors.slice(0, 3).map((color, colorIndex) => (
                        <div
                          ...
                          className={`w-4 h-4 rounded-full border border-gray-600 ${
                            ...
                            color === 'Gray' || color === 'Charcoal' ? 'bg-gray-500' :
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-3">
                  {!formData.audioFile ? (
                    <div className="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center hover:border-gray-500 transition-colors">
                      ...
                      <Button
                        type="button"
                        variant="outline"
                        className="mt-3 bg-transparent border-gray-600 text-gray-300 hover:bg-gray-800/50 font-medium"
                  ...
                  {errors.audioFile && (
                    <p className="text-red-400 text-sm font-light">{errors.audioFile}</p>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-black/50 border-gray-700 text-white placeholder:text-gray-500 min-h-[100px] font-light"
                />
              </div>
